...
public class UserPurchaseController {
	...
	// 결제 성공 시 장바구니 상품 데이터 삭제
	@DeleteMapping("/success/deleteCart/{email}/{prodCode}")
	public void deleteCart(@PathVariable(value = "email", required = true) String email,
			@PathVariable(value = "prodCode", required = true) String prodCode) {
		userPurchaseServiceImpl.deleteCart(email, prodCode);
	}
