...
////	public NoticeDTO getNoticeByNo(@PathVariable Integer notCode) {
////		return noticeService.getNotice(notCode);
////	}
//
//	// update board
//	@PutMapping("/noticeDTO/{no}")
//	public ResponseEntity<NoticeDTO> updateNoticeByNo(@PathVariable Integer no, @RequestBody NoticeDTO noticeDTO) {
//
...
//	public ResponseEntity<Map<String, Boolean>> deleteNoticeByNo(@PathVariable Integer no) {
//
