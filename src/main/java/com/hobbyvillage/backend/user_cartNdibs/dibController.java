...
public class dibController {
	...
	public List<dibDTO> getdiblists(@PathVariable("email") String email,
	...
	public List<dibDTO> getdibcategorylist(@PathVariable("email") String email) {
		return dibServiceImpl.getdibcategorylist(email);
	}

	// 상품 사진 조회
	@RequestMapping("/dibs/getPhoto")
	public String getdibitems(@RequestParam(value = "prodCode", required = true) String prodCode) {
